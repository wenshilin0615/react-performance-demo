 ...
 */
import React, { useState, useMemo, useTransition, Profiler } from 'react';
import './index.less';
  ...
  return (
    <Profiler id="DemoE-React19" onRender={onRenderCallback}>
      <div className="demo-e">
        <h2>Demo E - React 19 搜索演示（useTransition）</h2>
        <p>使用 useTransition 将列表更新降为低优先级，输入流畅</p>
        ...
        <div style={{ marginTop: '20px', padding: '15px', backgroundColor: '#e8f5e9', borderRadius: '4px' }}>
          ...
          <ul style={{ margin: '5px 0', paddingLeft: '20px' }}>
            <li>输入框更新为高优先级，立即响应</li>
            <li>列表更新为低优先级，不阻塞输入</li>
            <li>输入响应时间: &lt;50ms</li>
